...
(defn beginning-of
  ...
  (let [dt (the-date :datetime)
	res (cond
	     (= unit :year) (-> dt (.withMonth 1) (.withDayOfMonth 1) (.withTime 0 0 0 0))
	     (= unit :month) (-> dt (.withDayOfMonth 1) (.withTime 0 0 0 0))
	     (= unit :day) (.withTime dt 0 0 0 0)
	     (= unit :hour) (.withTime dt (.getHourOfDay dt) 0 0 0)
	     (= unit :minute) (.. dt (.withSecondOfMinute 0) )
	     (= unit :second) (.withMillisOfSecond dt 0))]
    (date res)))
